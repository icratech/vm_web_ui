<script>
	...
	import { Device, updateDevicesStore } from "../../des_api";
...
<div class="flx-col container">
    ...
    <div class="flx-col evts">
        { #each job_evts as evt ( evt.evt_time ) }
    ...
    <div class="flx-col">
        <EventBuilderOp bind:device on:complete={ async( ) => { await reloadEvents( ) } }/>
    </div>
