...
var init_layout_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/_layout.svelte.js"() {
    init_chunks();
    css$1 = {
      code: ".container.svelte-imojko{background-color:var(--light_aa);padding:0.3em 1em;justify-content:space-between;gap:0}.content.svelte-imojko{padding-left:1rem;justify-content:space-between}.title-block.svelte-imojko{min-width:20rem;gap:0}.icon-block.svelte-imojko{padding:0}.ent.svelte-imojko{font-size:1.8rem}.wat.svelte-imojko{font-size:1.8rem;color:var(--light)}.ch.svelte-imojko{font-size:1.8rem;color:var(--green)}.four.svelte-imojko{font-size:0.6em;font-weight:300;color:var(--green)}.subtitle.svelte-imojko{margin-top:-0.3em;padding-bottom:0.75em}.data-desk.svelte-imojko{font-style:oblique;color:var(--light)}.two.svelte-imojko{color:var(--green)}.login.svelte-imojko{align-items:center}",
      map: null
    };
    Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      $$result.css.add(css$1);
      return `<div class="flx-co container svelte-imojko"><div class="flx-row content svelte-imojko"><div class="flx-col title-block svelte-imojko"><div class="flx-row icon-block svelte-imojko"><h1>V<span class="ent svelte-imojko">ENT</span><span class="wat svelte-imojko">WAT</span><span class="ch svelte-imojko">CH</span><sub class="four svelte-imojko">4</sub></h1></div>
            <div class="subtitle svelte-imojko"><p>Part of the <span class="data-desk svelte-imojko">Data</span><span class="two svelte-imojko">2</span><span class="data-desk svelte-imojko">Desk</span> ecosystem</p></div></div>

        <div class="flx-row login svelte-imojko"></div></div>

</div>`;
    });
    css = {
      code: ".main.svelte-ftlwl1{background-color:var(--dark);color:var(--accent);padding:1em;height:100vh}.nav.svelte-ftlwl1{width:6em;gap:2em}.content.svelte-ftlwl1{height:100%}",
      map: null
    };
    Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      $$result.css.add(css);
      return `<div class="flx-col main svelte-ftlwl1">${validate_component(Header, "Header").$$render($$result, {}, {}, {})}

    <div class="flx-row layout"><div class="flx-col nav svelte-ftlwl1">
            <a href="/">HOME</a>
            <a href="/device">DEVICES</a>
            <a href="/job">JOBS</a>
            <a href="/demo">DEMO</a></div>

        <div class="flx-col content svelte-ftlwl1">${slots.default ? slots.default({}) : ``}</div></div>
...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    ...
    imports = ["_app/immutable/nodes/0.dd1ac7c2.js", "_app/immutable/chunks/index.76405911.js"];
    stylesheets = ["_app/immutable/assets/0.6943fe01.css", "_app/immutable/assets/InputText.b694eab1.css"];
    fonts = [];
  }
});
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    ...
    imports2 = ["_app/immutable/nodes/1.cf5cb0b9.js", "_app/immutable/chunks/index.76405911.js", "_app/immutable/chunks/singletons.f3213abc.js"];
    stylesheets2 = [];
    fonts2 = [];
  }
});
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/2.js"() {
    ...
    imports3 = ["_app/immutable/nodes/2.d51ca607.js", "_app/immutable/chunks/index.76405911.js"];
    stylesheets3 = [];
    fonts3 = [];
  }
});
...
var css$2, PillButton, css$12, InputText, css2, Page2;
var init_page_svelte2 = __esm({
  ".svelte-kit/output/server/entries/pages/demo/_page.svelte.js"() {
    init_chunks();
    css$2 = {
      code: "button.svelte-bjk7fz{cursor:pointer;border-radius:1.25em;border:0.1rem solid var( --light_aa);min-width:2.5em;min-height:2.5em;margin:0.2em}",
      map: null
    };
    PillButton = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { cls = "bg-accent" } = $$props;
      ...
      return `<button style="${"width: " + escape(width, true) + "; height: " + escape(height, true) + ";"}" class="${escape(null_to_empty(cls), true) + " svelte-bjk7fz"}"${add_attribute("type", type, 0)} ${!enabled ? "disabled" : ""}>${slots.default ? slots.default({}) : ``}
</button>`;
    });
    css$12 = {
      code: "#container.svelte-s60w4k{gap:0.25rem}#lbl.svelte-s60w4k{font-size:0.9rem}input.svelte-s60w4k{color:var(--light);background-color:var(--dark);padding:0.25rem 0.5rem;border-radius:0.2rem;border:0.1rem solid var(--light_a);width:100%}input.svelte-s60w4k:disabled{color:var(--grey);border:0.1rem solid transparent}",
      map: null
    };
    InputText = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { txt = null } = $$props;
      let { place = "" } = $$props;
      let { lbl = null } = $$props;
      ...
      if ($$props.lbl === void 0 && $$bindings.lbl && lbl !== void 0)
        $$bindings.lbl(lbl);
      if ($$props.enabled === void 0 && $$bindings.enabled && enabled !== void 0)
        $$bindings.enabled(enabled);
      $$result.css.add(css$12);
      return `<div class="flx-col svelte-s60w4k" id="container">${lbl != null ? `
        <label class="accent svelte-s60w4k" id="lbl">${escape(lbl)}</label>` : ``}

    <input type="text" spellcheck="value"${add_attribute("placeholder", place, 0)} ${!enabled ? "disabled" : ""} class="svelte-s60w4k"${add_attribute("value", txt, 0)}>

</div>`;
    });
    css2 = {
      code: ".new-device.svelte-41uiam{height:11em}",
      map: null
    };
    Page2 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      do {
        $$settled = true;
        $$rendered = `<div class="flx-row new-device svelte-41uiam">${validate_component(PillButton, "PillButton").$$render($$result, {}, {}, {})}
...
var init__4 = __esm({
  ".svelte-kit/output/server/nodes/3.js"() {
    ...
    imports4 = ["_app/immutable/nodes/3.ab40c627.js", "_app/immutable/chunks/index.76405911.js"];
    stylesheets4 = ["_app/immutable/assets/3.c35ffb86.css", "_app/immutable/assets/InputText.b694eab1.css"];
    fonts4 = [];
  }
});

// .svelte-kit/output/server/entries/pages/device/_page.server.js
var page_server_exports = {};
__export(page_server_exports, {
  load: () => load
});
var REQUEST_GET_DEVICES, load;
var init_page_server = __esm({
  ".svelte-kit/output/server/entries/pages/device/_page.server.js"() {
    REQUEST_GET_DEVICES = new Request("http://127.0.0.1:8003/001/001/devices", {
      method: "GET",
      headers: {
    ...
    load = async (serverLoadEvent) => {
      const { fetch: fetch2 } = serverLoadEvent;
      let res = await fetch2(REQUEST_GET_DEVICES);
...
// .svelte-kit/output/server/entries/pages/device/_page.svelte.js
...
<ul>${each(data.devices, (device) => {
        return `<li><a href="${"/device/" + escape(device.des_dev_serial, true)}">${escape(device.des_dev_serial)}</a></li>`;
      })}</ul>`;
    });
  }
});
...
var init__5 = __esm({
  ".svelte-kit/output/server/nodes/4.js"() {
    ...
    server_id = "src/routes/device/+page.server.js";
    imports5 = ["_app/immutable/nodes/4.d409a03b.js", "_app/immutable/chunks/index.76405911.js"];
    stylesheets5 = [];
    fonts5 = [];
  }
});

// .svelte-kit/output/server/entries/pages/device/_slug_/_page.server.js
var page_server_exports2 = {};
__export(page_server_exports2, {
  load: () => load2
});
var REQUEST_GET_DEVICES2, load2;
var init_page_server2 = __esm({
  ".svelte-kit/output/server/entries/pages/device/_slug_/_page.server.js"() {
    init_index2();
    new Request("http://127.0.0.1:8003/001/001/jobs", {
      method: "GET",
      headers: {
        "Content-Type": "application/json"
      }
    });
    REQUEST_GET_DEVICES2 = new Request("http://127.0.0.1:8003/001/001/devices", {
      method: "GET",
      headers: {
        "content-type": "application/json",
        "accept": "application/json"
    ...
    load2 = async ({ params }) => {
      let res = await fetch(REQUEST_GET_DEVICES2);
      let txt = await res.text();
      let devices = await JSON.parse(txt);
      let device = devices.find((device2) => device2.des_dev_serial === params.slug);
      if (!device)
...
// .svelte-kit/output/server/entries/pages/device/_slug_/_page.svelte.js
  ...
  ".svelte-kit/output/server/entries/pages/device/_slug_/_page.svelte.js"() {
    ...
    Page4 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      if ($$props.data === void 0 && $$bindings.data && data !== void 0)
        $$bindings.data(data);
      device = data;
      return `<h3>SN: ${escape(device.des_dev_serial)}</h3>
<p>CLASS: ${escape(device.des_dev_class)}</p>
<p>VERSION: ${escape(device.des_dev_version)}</p>
`;
    });
  }
});
...
var init__6 = __esm({
  ".svelte-kit/output/server/nodes/5.js"() {
    ...
    server_id2 = "src/routes/device/[slug]/+page.server.js";
    imports6 = ["_app/immutable/nodes/5.6e722942.js", "_app/immutable/chunks/index.76405911.js"];
    stylesheets6 = [];
    fonts6 = [];
  }
});

// .svelte-kit/output/server/entries/pages/job/_page.server.js
...
// .svelte-kit/output/server/entries/pages/job/_page.svelte.js
...
var init__7 = __esm({
  ".svelte-kit/output/server/nodes/6.js"() {
    ...
    server_id3 = "src/routes/job/+page.server.js";
    imports7 = ["_app/immutable/nodes/6.08192529.js", "_app/immutable/chunks/index.76405911.js"];
    stylesheets7 = [];
    fonts7 = [];
  }
});

// .svelte-kit/output/server/entries/pages/job/_slug_/_page.server.js
...
// .svelte-kit/output/server/entries/pages/job/_slug_/_page.svelte.js
...
var init__8 = __esm({
  ".svelte-kit/output/server/nodes/7.js"() {
    ...
    server_id4 = "src/routes/job/[slug]/+page.server.js";
    imports8 = ["_app/immutable/nodes/7.08192529.js", "_app/immutable/chunks/index.76405911.js"];
    stylesheets8 = [];
    fonts8 = [];
  }
});
    ...
    app: ({ head, body, assets: assets2, nonce, env }) => '<!DOCTYPE html>\n<html lang="en">\n	<head>\n		<meta charset="utf-8" />\n		<link rel="icon" href="' + assets2 + `/favicon.png" />
        ...
        <style>
            * {
            ...
            h3 { font-size: 1.8em; font-weight: 300; font-style: oblique; }
            ...
            input:focus { outline: 0.1rem solid var(--accent_a); outline-offset: 0.15rem; }
            ...
            :root {
                --dark: rgb(40, 40, 40);
                --dark_a: rgb(40, 40, 40, 0.7);
                --dark_aa: rgb(40, 40, 40, 0.4);
                ...
                --light_aa: rgb(230, 230, 230, 0.023);
                ...
                --yellow_aa: rgb(230, 180, 20, 0.4);

                --green: rgb(60, 210, 0); /*rgb(80, 170, 35);*/
                --green_a: rgb(60, 210, 0, 0.7);
                --green_aa: rgb(60, 210, 0, 0.4);

                --aqua: rgb(50, 230, 230);
                --aqua_a: rgb(50, 230, 230, 0.7);
                --aqua_aa: rgb(50, 230, 230, 0.4);

                --blue: rgb(10, 120, 230);
                --blue_a: rgba(110, 120, 230, 0.7);
                --blue_aa: rgba(10, 120, 230, 0.4);

                --purple: rgb(160, 70, 240);
                --purple_a: rgb(160, 70, 240, 0.7);
                --purple_aa: rgb(160, 70, 240, 0.4);
            ...
            .fg-orange { color: var( --orange_a); }
            .fg-yellow { color: var( --yellow_a); }

            .fg-green { color: var( --green); }

            .fg-green_a { color: var( --green_a); }
            ...
            .fg-purple_a { color: var( --purple_a ); }
            .fg-purple_a:hover { color: var( --purple ); }

            .fg-pink { color: var( --pink_a); }
...
var manifest = (() => {
  ...
  return {
    ...
    _: {
      client: { "start": "_app/immutable/entry/start.d8b561f9.js", "app": "_app/immutable/entry/app.a7b0a888.js", "imports": ["_app/immutable/entry/start.d8b561f9.js", "_app/immutable/chunks/index.76405911.js", "_app/immutable/chunks/singletons.f3213abc.js", "_app/immutable/entry/app.a7b0a888.js", "_app/immutable/chunks/index.76405911.js"], "stylesheets": [], "fonts": [] },
      nodes: [
